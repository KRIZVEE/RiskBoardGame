...
public class RiskGame {
	...
	/**
	 * This method is creating a new hasmap conatining all players with 0 number
	 * of cards. This hashmap is used incalculating the reinforcement armies.
	 * 
	 * @throws IOException
	 */
	 ...
	 * which will be used to count number of reinforcement armies accordign to
	 * card trade.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * In this method the reinforcement armies are counted in the basis of
	 * continet the player owns.
	 */
	public void armiesFromContinent() {
		...
		System.out.println(
				currentPlayer.getName() + " got " + noOfReinforcementArmies + " armies from their owning continents.");
	}
	...
	public void armiesFromCountrySize() {
		...
		if (sizeOfCountriesCurrentPlayerOwn < 9) {
			...
			System.out.println(currentPlayer.getName() + " got " + sizeOfCountriesCurrentPlayerOwn / 3
					+ " armies from his/her owned countries.");
		}
	...
	public void playCards() throws IOException {
		...
		if (numberOfCardsPlayerHave >= 3) {
			System.out.println("Currently noOfReinforcementArmies" + noOfReinforcementArmies);
			...
			if (result.equals("Y")) {
				...
				System.out.println(
						currentPlayer.getName() + " got " + 5 * initialFlagForCards + " armies by trading the cards.");
		...
		// System.out.println("Armies player own earlier = " +
		// currentPlayer.getArmies());
		...
		// System.out.println("Armies player own now = " +
		// currentPlayer.getArmies() + "\n");
		// card = 1;
		// int newTurn = turn + 1;
	...
	public void placeReinforcementArmies() throws IOException {
		...
		System.out.println(currentPlayer.getName() + " you have " + noOfReinforcementArmies
				+ " number of total reinforcement armies");
		Scanner sc = new Scanner(System.in);
		Scanner sc1 = new Scanner(System.in);
		...
		System.out.println("noOfReinforcementArmies :  " + noOfReinforcementArmies);
		int newSize = noOfReinforcementArmies;
		System.out.println("newSize   :   " + newSize);
		// System.out.println(" currentPlayer : GET ARMIES B4 " +
		// currentPlayer.getArmies());

		currentPlayer.addArmies(newSize);
		// System.out.println(" currentPlayer : " + currentPlayer.getArmies());
	...
	/**
	 * This method takes country name to enter the armies and number of armies
	 * want to place from the user and then perform the operation. of the game.
	 * 
	 * @param countryNameToEnterArmies
	 *            is used to define the name of country to enter the armies to.
	 * @param noOfArmiesWantToPlace
	 *            is used to specify the number of armies player wants to plave
