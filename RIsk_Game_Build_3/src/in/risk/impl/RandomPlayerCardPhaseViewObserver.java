...
public class RandomPlayerCardPhaseViewObserver implements Observer{
...
//		System.out.println(((StartUpPhase) o).countriesArmies);
		...
		System.out.println(((RandomPlayer) o).noOfReinforcementArmiesFromCountries);

		System.out.println("Armies assigned from Risk RUle based on continent owning");
		System.out.println(((RandomPlayer) o).noOfReinforcementArmiesFromContinents);

		System.out.println("Armies assigned from Risk RUle based on card owning");
		System.out.println(((RandomPlayer) o).noOfReinforcementArmiesFromCards);
