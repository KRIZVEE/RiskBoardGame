...
public class CheaterPlayerGamePhaseViewObserver implements Observer{
...
//		System.out.println(((StartUpPhase) o).countriesArmies);
		...
		System.out.println(((CheaterPlayer) o).noOfArmiesFromCountries);

		System.out.println("Armies assigned from Risk RUle based on continent owning");
		System.out.println(((CheaterPlayer) o).noOfArmiesFromContinents);

		System.out.println("Armies assigned from Risk RUle based on card owning");
		System.out.println(((CheaterPlayer) o).noOfArmiesFromCards);

		System.out.println("Updated Army List");
		System.out.println(((CheaterPlayer) o).countriesArmiesObserver);
		
		
//		//attack
		
		System.out.println("Player chose below country to attack FROM : ");
		System.out.println(((CheaterPlayer) o).attackerCountry);

		System.out.println("Player chose below country to attack TO : ");
		System.out.println(((CheaterPlayer) o).defenderCountry);

		System.out.println("Attacker Dice Chosen Value");
		System.out.println(((CheaterPlayer) o).noOfAttackerDice);

		System.out.println("Defender Dice Chosen Value");
		System.out.println(((CheaterPlayer) o).noOfDefenderDice);

		System.out.println("Updated Country list and corresponding army values :");
		System.out.println(((CheaterPlayer) o).initialPlayerCountryObserver + "	" + ((CheaterPlayer) o).countriesArmiesObserver);
////
////		//System.out.println((RandomPlayer) o).initialPlayerCountryObserver + "   " + (CheaterPlayer) o).countriesArmiesObserver);

		System.out.println("How many time attacked happened");
		System.out.println(((CheaterPlayer) o).countNoOfAttack);
		
		//fortify
		
		System.out.println("chosen country FROM where to move army/armies :  ");
		System.out.println(((CheaterPlayer) o).countriesOfCheaterPlayer);

//		System.out.println("chosen country TO where to move army/armies :  ");
//		System.out.println(((CheaterPlayer) o).to);
